...
from .ext.instant_mesh.utils.camera_util import (
    FOV_to_intrinsics,
    get_circular_camera_poses,
    get_zero123plus_input_cameras,
)
from .ext.instant_mesh.utils.infer_util import resize_foreground
from .ext.instant_mesh.utils.mesh_util import save_obj, save_obj_with_mtl
from .ext.instant_mesh.utils.train_util import instantiate_from_config
...
class MyInstantMesh:
    def __init__(
        ...
        self.IS_FLEXICUBES = (
            True if self.config_name.startswith("instant-mesh") else False
        )
        ...
        if os.path.isdir(input_path):
            self.input_files = [
                ...
                and not file.endswith("black.jpg")
            ]
        else:
