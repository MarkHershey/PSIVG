...
class TrackAnythingPipeline:
    ...
    def track(self, frame_data: VideoFrame) -> tuple[torch.Tensor, dict[int, str]]:
        ...
        if self.frame_idx == 0:
            # self.caption contains all the pre-defined phrases to track.
            # pred_mask is a combined mask of all interactive objects (using the pre-defined phrases) in the frame.
