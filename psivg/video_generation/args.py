...
def _get_dataset_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default="noises.txt",
        help="The column of the dataset containing the noises for each video.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="masks.txt",
        help="The column of the dataset containing the masks for each video.",
    )

    parser.add_argument(
        "--caption_fg_column",
        type=str,
        default="prompt_fg.txt",
        help="The name of the file in `--data_root` folder containing the line-separated foreground prompt for each video.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.5,
        help="The amount of degradation to process the noise with",
    )
  
    parser.add_argument(
        "--video_id",
        type=str,
        help="To select the video for test-time training.",
    )
...
def _get_validation_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument( 
        ...
        type=str,
        default=None,
        help="Path to validation noise. Should be path to .npy file. Can see validation_images for more information.",
    )
...
def _get_training_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            'The setting name to save our experiments (experiment folder)'
        ),
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Whether to optimize the prompt instead of the LoRA layers.",
    ) 

    #### To optimize the text prompt input for each foreground token, for each layer
    parser.add_argument(
        "--optimize_prompt_each_layer",
        action="store_true",
        default=False,
        help="Whether to optimize the prompt differently for different layers.",
    ) 

    ### Added to sample the timesteps for training
    parser.add_argument(
        "--timestep_sampling",
        type=str,
        default="uniform_random",
        help=(
            'The timestep sampling of the DM during training. Choose between ["uniform_random", "noisy_steps"]'
        ),
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=700,
        help="The threshold between being a low-noise time step and a high-noise time step.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="The path to the lora weights to load.",
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Whether to use the merged noises for optimization.",
    )

    parser.add_argument("--noise_downtemp_interp", type=str, default="nearest")
